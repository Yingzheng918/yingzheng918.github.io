...
// meed <canvas id="confetti"></canvas>
    ...
    "confetti.js": [
      function (require, module, exports) {
        ...
        document.addEventListener("DOMContentLoaded", function () {
          ...
          /**
           * 通过 MutationObserver 来监听 #Gissues
           */

          function beaudarEnd() {
            var targetNode = document.getElementById("Gissues");
            var options = {
              attributes: true,
              childList: true,
              subtree: true,
            ...
            function callback(mutationsList) {
              mutationsList.forEach(function (element) {
                if (element.type === "attributes" && element.target.className === "Gissues") {
                  confetti.resize();
                }
              });
            }
